...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Account-wide currencies (CurrencyTypesFlags::AccountWide)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `battlenet_account_warband_groups`
--

DROP TABLE IF EXISTS `battlenet_account_warband_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `battlenet_account_warband_groups` (
  `battlenetAccountId` int unsigned NOT NULL,
...
--
-- Dumping data for table `battlenet_account_warband_groups`
--

LOCK TABLES `battlenet_account_warband_groups` WRITE;
/*!40000 ALTER TABLE `battlenet_account_warband_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_warband_groups` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `battlenet_account_warband_group_members`
--

DROP TABLE IF EXISTS `battlenet_account_warband_group_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `battlenet_account_warband_group_members` (
  `battlenetAccountId` int unsigned NOT NULL,
  `groupId` bigint unsigned NOT NULL,
...
--
-- Dumping data for table `battlenet_account_warband_group_members`
--

LOCK TABLES `battlenet_account_warband_group_members` WRITE;
/*!40000 ALTER TABLE `battlenet_account_warband_group_members` DISABLE KEYS */;
/*!40000 ALTER TABLE `battlenet_account_warband_group_members` ENABLE KEYS */;
UNLOCK TABLES;
...
('2026_04_22_00_auth.sql','FA3426E1D920AD15ABA9F3B43630CAD4B3A73704','RELEASED','2026-04-22 18:42:10',0),
('2026_04_23_00_auth.sql','7FF5A1098DDB029004A8822D2A1545878F269D25','RELEASED','2026-04-23 18:44:59',0),
('2026_04_24_00_auth.sql','8C1C15C9672C557D91E2AE61521F8063F6030F14','RELEASED','2026-04-24 09:39:50',0),
('2026_04_29_00_auth.sql','035B7C240CDAC17FDC883175D5C0ABAFA432FDDD','RELEASED','2026-04-29 00:00:29',0),
