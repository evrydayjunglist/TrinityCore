-- Archaeology Phase 2F nine-branch: Outland (530) / Northrend (571) dig-site branch mappings.
-- Sourced from Archy Digsites.lua blobID = ResearchSite.QuestPOIBlobID joined to ResearchBranch
-- via race->fragment currency (same join as EK/Kalimdor). findCount=6 (Cata sniff).
-- Coverage: Outland 28/28, Northrend 30/30 DB2 sites.
-- Dual-check: free NN 13 on master + evry for 2026_13_32 world (2026-07-22).
