-- DB/Forbidden Reach: Dracthyr Evoker intro wiring (ported from sql/old/10.x/world/24021_2024_05_11/2024_02_24_00_world.sql)
...
(@OGUID+0, 378473, 2570, 13769, 13806, '0', 0, 0, 5739.970703125, -3023.970458984375, 251.0890045166015625, 3.194002151489257812, 0, 0, -0.99965667724609375, 0.026201646775007247, 120, 255, 1, 64978), -- Starting Room Collision (Area: The War Creche - Difficulty: 0) CreateObject1
(@OGUID+1, 378473, 2570, 13769, 13806, '0', 0, 0, 5754.30029296875, -3056.350830078125, 251.0890045166015625, 3.926995515823364257, 0, 0, -0.92387866973876953, 0.38268551230430603, 120, 255, 1, 64978), -- Starting Room Collision (Area: The War Creche - Difficulty: 0) CreateObject1
(@OGUID+2, 378473, 2570, 13769, 13806, '0', 0, 0, 5818.52978515625, -3054.560791015625, 251.279998779296875, 5.480334281921386718, 0, 0, -0.39073085784912109, 0.920504987239837646, 120, 255, 1, 64978), -- Starting Room Collision (Area: The War Creche - Difficulty: 0) CreateObject1
(@OGUID+3, 378473, 2570, 13769, 13806, '0', 0, 0, 5787.44970703125, -3069.34033203125, 251.08502197265625, 4.729844093322753906, 0, 0, -0.70090866088867187, 0.713251054286956787, 120, 255, 1, 64978); -- Starting Room Collision (Area: The War Creche - Difficulty: 0) CreateObject1

DELETE FROM `conditions` WHERE (`SourceTypeOrReferenceId` = 32 AND `SourceGroup` = 8 AND `SourceEntry` = 378473);
...
(26052, 0, 30308, 0, 4, 0, 0, 0, 0, -1, 0, 0, NULL, 0, 0, 3, 3, 0, 0, 0, 0, 0, 0, 'at_dracthyr_stasis_feedback', 64978); -- Spell: 382137 (Stasis)
