-- DB/Forbidden Reach: Dracthyr Evoker Kodethi/Dervishian spellclick (ported from sql/old/10.x/world/24021_2024_05_11/2024_04_08_01_world.sql)
...
-- Spellclick Disintegrate: quest credit + stasis break (DBC effects target NPC, not player)
DELETE FROM `spell_script_names` WHERE `spell_id`=362355 AND `ScriptName`='spell_disintegrate_dracthyr_awaken';
INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES
(362355, 'spell_disintegrate_dracthyr_awaken');
