...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_PLAYER_HOUSES_INFO,                STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetPlayerHousesInfo);
    ...
    DEFINE_HANDLER(CMSG_MOVE_SET_TURN_RATE_CHEAT,                           STATUS_IGNORED,   PROCESS_THREADSAFE,   &WorldSession::Handle_NULL);
    ...
    DEFINE_HANDLER(CMSG_PERKS_PROGRAM_STATUS_REQUEST,                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandlePerksProgramStatusRequest);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_STORE_FRONT_INFO_UPDATE,                    STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestStoreFrontInfoUpdate);
    ...
    DEFINE_HANDLER(CMSG_SET_EXCLUDED_CHAT_CENSOR_SOURCES,                   STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetExcludedChatCensorSources);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACCOUNT_CHARACTER_CURRENCY_LISTS,                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_TRANSFER_LOG,                                        STATUS_NEVER,       CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_CURRENCY_TRANSFER_RESULT,                                     STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GET_LANDING_PAGE_SHIPMENTS_RESPONSE,                          STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_GET_REMAINING_GAME_TIME_RESPONSE,                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    // Phase 1 wild slice sends these; STATUS_UNHANDLED drops SendPacket (see WorldSession::SendPacket).
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_RAF_ACCOUNT_INFO,                                             STATUS_NEVER,       CONNECTION_TYPE_REALM);
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WEEKLY_REWARDS_PROGRESS_RESULT,                               STATUS_NEVER,       CONNECTION_TYPE_REALM);
