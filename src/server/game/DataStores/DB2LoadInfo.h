...
struct WarbandScenePlacementLoadInfo
{
    static constexpr DB2FieldMeta Fields[13] =
    {
        ...
        { .IsSigned = false, .Type = FT_FLOAT, .Name = "Scale" },
        { .IsSigned = false, .Type = FT_INT, .Name = "Field54210_004" },
        { .IsSigned = false, .Type = FT_INT, .Name = "Field54210_005" },
        { .IsSigned = true, .Type = FT_INT, .Name = "Field12063534_008" },
        { .IsSigned = true, .Type = FT_INT, .Name = "SlotID" },
        { .IsSigned = true, .Type = FT_INT, .Name = "Field12063534_010" },
    };
