...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_ACCOUNT_CHARACTER_CURRENCY_FOR_TRANSFER,
    CHAR_SEL_ACCOUNT_CHARACTER_CURRENCY_BY_ACCOUNT,
    CHAR_SEL_CHARACTER_CURRENCY_QUANTITY,
    CHAR_UPD_CHARACTER_CURRENCY_QUANTITY,
    CHAR_DEL_CHARACTER_CURRENCY_BY_GUID,
    CHAR_SEL_CHARACTER_ONLINE_BY_GUID,
    CHAR_INS_ACCOUNT_CURRENCY_TRANSFER_LOG,
    CHAR_SEL_ACCOUNT_CURRENCY_TRANSFER_LOG,
    ...
    CHAR_SEL_CHARACTER_CHROMIE_TIME,
    CHAR_DEL_CHARACTER_CHROMIE_TIME,
    CHAR_INS_CHARACTER_CHROMIE_TIME,
