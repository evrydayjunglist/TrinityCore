...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BNET_ACCOUNT_INFO_BY_ACCOUNT_ID,
    ...
    LOGIN_SEL_BNET_ACCOUNT_CURRENCY,
    LOGIN_INS_BNET_ACCOUNT_CURRENCY,
    LOGIN_UPD_BNET_ACCOUNT_CURRENCY,
    LOGIN_DEL_BNET_ACCOUNT_CURRENCY,

    LOGIN_SEL_BNET_ACCOUNT_ACHIEVEMENT,
    LOGIN_INS_BNET_ACCOUNT_ACHIEVEMENT,
    LOGIN_DEL_BNET_ACCOUNT_ACHIEVEMENT,
    LOGIN_DEL_BNET_ACCOUNT_ACHIEVEMENT_BY_ACHIEVEMENT,
    LOGIN_SEL_BNET_ACCOUNT_ACHIEVEMENT_PROGRESS,
    LOGIN_INS_BNET_ACCOUNT_ACHIEVEMENT_PROGRESS,
    LOGIN_DEL_BNET_ACCOUNT_ACHIEVEMENT_PROGRESS,
    LOGIN_DEL_BNET_ACCOUNT_ACHIEVEMENT_PROGRESS_BY_CRITERIA,
